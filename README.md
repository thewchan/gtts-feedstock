...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/gtts-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15052&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/gtts-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `gtts` can be installed with:

```
conda install gtts
```

It is possible to list all of the versions of `gtts` available on your platform with:
